 ...
 */
export type Animation<TConfig extends Record<string, any> = Record<string, any>> =
  | boolean
  | "disabled"
 ...
 */
export type AnimationRoot<TConfig extends Record<string, any> = Record<string, any>> =
  | boolean
  | "disabled"
  | "disable-all"
