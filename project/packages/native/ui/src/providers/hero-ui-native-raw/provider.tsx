...
import type { PitsiUINativeProviderRawProps } from "./types";

/**
 * PitsiUINativeProviderRaw Component
 *
 * @description
 * Raw provider component for PitsiUI Native that configures the application
 ...
 *
 * @param {PitsiUINativeProviderRawProps} props - Provider configuration props
 * @param {ReactNode} props.children - Child components to wrap
 * @param {PitsiUINativeConfigRaw} [props.config] - Configuration object
 *
 */
const PitsiUINativeProviderRaw: React.FC<PitsiUINativeProviderRawProps> = ({
  children,
  config = {},
}) => {
  ...
  return (
    ...
    >
      <GlobalAnimationSettingsProvider animation={animation}>
        <TextComponentProvider value={{ textProps }}>{children}</TextComponentProvider>
      </GlobalAnimationSettingsProvider>
    </SafeAreaListener>
  );
};

export default PitsiUINativeProviderRaw;
