...
const Trigger = forwardRef<TriggerRef, TriggerProps>(
  (
    { asChild, onPress: onPressProp, onLayout: onLayoutProp, isDisabled = false, ...props },
    ref,
  ) => {
    const {
      onOpenChange,
...
const PopoverContent = forwardRef<ContentRef, PopoverContentProps>(
  (
    ...
    useEffect(() => {
      ...
      // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [setTriggerPosition, setContentLayout, onOpenChange]);
...
const ItemLabel = React.forwardRef<ItemLabelRef, ItemLabelProps>(({ asChild, ...props }, ref) => {
...
Root.displayName = "PitsiUINative.Primitive.Select.Root";
Trigger.displayName = "PitsiUINative.Primitive.Select.Trigger";
TriggerIndicator.displayName = "PitsiUINative.Primitive.Select.TriggerIndicator";
Value.displayName = "PitsiUINative.Primitive.Select.Value";
Overlay.displayName = "PitsiUINative.Primitive.Select.Overlay";
PopoverContent.displayName = "PitsiUINative.Primitive.Select.PopoverContent";
DialogContent.displayName = "PitsiUINative.Primitive.Select.DialogContent";
Close.displayName = "PitsiUINative.Primitive.Select.Close";
Item.displayName = "PitsiUINative.Primitive.Select.Item";
ItemLabel.displayName = "PitsiUINative.Primitive.Select.ItemLabel";
ItemIndicator.displayName = "PitsiUINative.Primitive.Select.ItemIndicator";
Group.displayName = "PitsiUINative.Primitive.Select.Group";
GroupLabel.displayName = "PitsiUINative.Primitive.Select.GroupLabel";
