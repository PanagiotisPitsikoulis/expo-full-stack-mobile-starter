...
const BottomSheetContext = createContext<(RootContext & { nativeID: string }) | null>(null);

const Root = forwardRef<RootRef, RootProps>(
  (
    { asChild, isOpen: isOpenProp, isDefaultOpen, onOpenChange: onOpenChangeProp, ...viewProps },
    ref,
  ) => {
...
Root.displayName = "PitsiUINative.Primitive.BottomSheet.Root";
...
Trigger.displayName = "PitsiUINative.Primitive.BottomSheet.Trigger";
...
Overlay.displayName = "PitsiUINative.Primitive.BottomSheet.Overlay";

// --------------------------------------------------

const Content = forwardRef<ContentRef, ContentProps>(({ asChild, ...props }, ref) => {
...
Content.displayName = "PitsiUINative.Primitive.BottomSheet.Content";
...
Close.displayName = "PitsiUINative.Primitive.BottomSheet.Close";
...
Title.displayName = "PitsiUINative.Primitive.BottomSheet.Title";
...
Description.displayName = "PitsiUINative.Primitive.BottomSheet.Description";
