...
const Root = forwardRef<RootRef, RootProps>(({ asChild, alt, ...viewProps }, ref) => {
...
const Image = forwardRef<ImageRef, ImageProps>(
  (
    ...
    const previousSourceRef = React.useRef<ImageProps["source"] | undefined>(undefined);
...
const Fallback = forwardRef<FallbackRef, FallbackProps>(({ asChild, ...props }, ref) => {
