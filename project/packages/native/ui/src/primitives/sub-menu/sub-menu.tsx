...
const Trigger = forwardRef<TriggerRef, TriggerProps>(
  (
    { asChild, textValue, onPress: onPressProp, isDisabled: isDisabledProp = false, ...props },
    ref,
  ) => {
    const { nativeID, isOpen, onOpenChange, isDisabled: isDisabledRoot } = useSubMenuContext();
...
Root.displayName = "PitsiUINative.SubMenu.Root";
Trigger.displayName = "PitsiUINative.SubMenu.Trigger";
Content.displayName = "PitsiUINative.SubMenu.Content";
