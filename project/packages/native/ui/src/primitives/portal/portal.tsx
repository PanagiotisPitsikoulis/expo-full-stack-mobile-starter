...
import type { ModalPortalRootReturn, PortalHostProps, PortalProps } from "./portal.types";

const DEFAULT_PORTAL_HOST = "PITSIUI_NATIVE_DEFAULT_HOST_NAME";
 ...
 */
export function useModalPortalRoot(): ModalPortalRootReturn {
