...
Root.displayName = "PitsiUINative.Primitive.Dialog.Root";
...
Trigger.displayName = "PitsiUINative.Primitive.Dialog.Trigger";
...
const Overlay = forwardRef<OverlayRef, OverlayProps>(
  ({ asChild, forceMount, isCloseOnPress = true, onPress: OnPressProp, ...props }, ref) => {
    const { isOpen, onOpenChange } = useRootContext();
...
Overlay.displayName = "PitsiUINative.Primitive.Dialog.Overlay";
...
Content.displayName = "PitsiUINative.Primitive.Dialog.Content";
...
Close.displayName = "PitsiUINative.Primitive.Dialog.Close";
...
Title.displayName = "PitsiUINative.Primitive.Dialog.Title";
...
Description.displayName = "PitsiUINative.Primitive.Dialog.Description";
