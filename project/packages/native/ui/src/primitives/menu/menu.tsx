...
const Group = forwardRef<GroupRef, GroupProps>(
  (
    ...
    const [internalSelectedKeys, setInternalSelectedKeys] = useState<Set<MenuKey>>(
...
const Item = forwardRef<ItemRef, ItemProps>(
  (
    ...
    const effectiveCloseOnSelect = isInsideGroup
      ? (shouldCloseOnSelectProp ?? groupContext.shouldCloseOnSelect ?? defaultCloseOnSelect)
      ...
      (ev: GestureResponderEvent) => {
        ...
        if (isInsideGroup && itemId !== undefined) {
          ...
          if (selectionMode === "single") {
            ...
            const newKeys = isSelected ? new Set<MenuKey>() : new Set<MenuKey>([itemId]);
...
const ItemTitle = forwardRef<ItemTitleRef, ItemTitleProps>(({ asChild, ...props }, ref) => {
  useItemContext();
...
Root.displayName = "PitsiUINative.Menu.Root";
Trigger.displayName = "PitsiUINative.Menu.Trigger";
Overlay.displayName = "PitsiUINative.Menu.Overlay";
Content.displayName = "PitsiUINative.Menu.Content";
Close.displayName = "PitsiUINative.Menu.Close";
Group.displayName = "PitsiUINative.Menu.Group";
Item.displayName = "PitsiUINative.Menu.Item";
ItemTitle.displayName = "PitsiUINative.Menu.ItemTitle";
ItemDescription.displayName = "PitsiUINative.Menu.ItemDescription";
ItemIndicator.displayName = "PitsiUINative.Menu.ItemIndicator";
Label.displayName = "PitsiUINative.Menu.Label";
