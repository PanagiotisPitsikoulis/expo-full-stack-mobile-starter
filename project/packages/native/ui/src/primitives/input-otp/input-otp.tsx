...
Root.displayName = "PitsiUINative.Primitive.InputOTP.Root";

// --------------------------------------------------

const Group = forwardRef<GroupRef, GroupProps>(
  ({ asChild, accessible = false, accessibilityRole = "none", ...props }, ref) => {
...
Group.displayName = "PitsiUINative.Primitive.InputOTP.Group";
...
Slot.displayName = "PitsiUINative.Primitive.InputOTP.Slot";
...
Separator.displayName = "PitsiUINative.Primitive.InputOTP.Separator";
