...
const Root = forwardRef<RootRef, RootProps>(
  (
    ...
    const [internalSelectedKeys, setInternalSelectedKeys] = useState<Set<TagKey>>(
...
Root.displayName = "PitsiUINative.Primitive.TagGroup.Root";
...
List.displayName = "PitsiUINative.Primitive.TagGroup.List";
...
const Item = forwardRef<ItemRef, ItemProps>(
  (
    { asChild, id: itemId, isDisabled: isDisabledProp = false, onPress: onPressProp, ...props },
    ref,
  ) => {
    const {
      selectionMode,
    ...
    const onPress = useCallback(
      (ev: GestureResponderEvent) => {
        ...
        if (selectionMode === "single") {
          const newKeys = isSelected ? new Set<TagKey>() : new Set<TagKey>([itemId]);
...
Item.displayName = "PitsiUINative.Primitive.TagGroup.Item";

// --------------------------------------------------
// ItemLabel
// --------------------------------------------------

const ItemLabel = forwardRef<ItemLabelRef, ItemLabelProps>(({ asChild, ...props }, ref) => {
  const Component = asChild ? Slot.Text : Text;

  return <Component ref={ref} {...props} />;
});

ItemLabel.displayName = "PitsiUINative.Primitive.TagGroup.ItemLabel";
...
RemoveButton.displayName = "PitsiUINative.Primitive.TagGroup.RemoveButton";
