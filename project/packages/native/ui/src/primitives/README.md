...
These primitives have been adapted for use in PitsiUI Native with modifications for:

- TypeScript compatibility and stricter typing
- Integration with PitsiUI Native's theme system
- Enhanced accessibility features
- Custom styling patterns aligned with PitsiUI design principles

## Usage

These primitives serve as the foundation for PitsiUI Native's component library. They provide:
