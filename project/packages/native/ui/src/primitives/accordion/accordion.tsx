...
const Root = forwardRef<RootRef, RootProps>(
  (
    ...
    const [value = selectionMode === "multiple" ? [] : undefined, onValueChange] =
...
Root.displayName = "PitsiUINative.Primitive.Accordion.Root";
...
const Item = forwardRef<ItemRef, ItemProps>(({ asChild, value, isDisabled, ...viewProps }, ref) => {
...
Item.displayName = "PitsiUINative.Primitive.Accordion.Item";
...
const Header = forwardRef<HeaderRef, HeaderProps>(({ asChild, ...props }, ref) => {
...
Header.displayName = "PitsiUINative.Primitive.Accordion.Header";

// --------------------------------------------------

const Trigger = forwardRef<TriggerRef, TriggerProps>(
  ({ asChild, onPress: onPressProp, isDisabled: disabledProp, ...props }, ref) => {
    const {
...
Trigger.displayName = "PitsiUINative.Primitive.Accordion.Trigger";

// --------------------------------------------------

const Indicator = forwardRef<IndicatorRef, IndicatorProps>(({ asChild, ...props }, ref) => {
  const Component = asChild ? Slot.View : View;

  return <Component ref={ref} role="presentation" aria-hidden={true} {...props} />;
});

Indicator.displayName = "PitsiUINative.Primitive.Accordion.Indicator";

// --------------------------------------------------

const Content = forwardRef<ContentRef, ContentProps>(({ asChild, forceMount, ...props }, ref) => {
...
Content.displayName = "PitsiUINative.Primitive.Accordion.Content";
