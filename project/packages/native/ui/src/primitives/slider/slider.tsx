...
const Root = forwardRef<RootRef, RootProps>(
  (
    ...
    const values = useMemo(
      () => normalizeValue(internalValue ?? minValue).map((v) => clamp(v, minValue, maxValue)),
    ...
    const setThumbDragging = useCallback((index: number, dragging: boolean): void => {
...
Root.displayName = "PitsiUINative.Primitive.Slider.Root";
...
Track.displayName = "PitsiUINative.Primitive.Slider.Track";
...
Fill.displayName = "PitsiUINative.Primitive.Slider.Fill";
...
const Thumb = forwardRef<ThumbRef, ThumbProps>(
  ({ asChild, index = 0, onLayout, ...props }, ref) => {
    const { orientation, isDisabled, getThumbPercent, getThumbValueLabel, setThumbSize } =
      useSlider();
...
Thumb.displayName = "PitsiUINative.Primitive.Slider.Thumb";

// --------------------------------------------------
// Output – resolves render-function children via context
// --------------------------------------------------

const Output = forwardRef<OutputRef, OutputProps>(({ asChild, children, ...restProps }, ref) => {
...
Output.displayName = "PitsiUINative.Primitive.Slider.Output";
