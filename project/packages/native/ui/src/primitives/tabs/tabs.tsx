...
Root.displayName = "PitsiUINative.Primitive.Tabs.Root";
...
List.displayName = "PitsiUINative.Primitive.Tabs.List";
...
Indicator.displayName = "PitsiUINative.Primitive.Tabs.Indicator";
...
const Trigger = forwardRef<TriggerRef, TriggerProps>(
  ({ asChild, onPress: onPressProp, disabled, value: tabValue, ...props }, ref) => {
    ...
    return (
      <TriggerContext.Provider value={{ value: tabValue, nativeID: tabNativeID, isSelected }}>
        <Component
          ref={ref}
...
Trigger.displayName = "PitsiUINative.Primitive.Tabs.Trigger";
...
const Label = forwardRef<LabelRef, LabelProps>(({ asChild, ...props }, ref) => {
  ...
  return (
    <Component ref={ref} nativeID={`${nativeID}-label`} aria-labelledby={nativeID} {...props} />
  );
});

Label.displayName = "PitsiUINative.Primitive.Tabs.Label";
...
Content.displayName = "PitsiUINative.Primitive.Tabs.Content";
