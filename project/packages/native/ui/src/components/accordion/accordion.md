...
```tsx
import { Accordion } from '@pitsi-ui/native';
```
...
```tsx
import { Accordion, PressableFeedback } from '@pitsi-ui/native';
...
```tsx
import { Accordion, useThemeColor } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/accordion.tsx>).
...
```tsx
import { useAccordion } from '@pitsi-ui/native';
...
```tsx
import { useAccordionItem } from '@pitsi-ui/native';
...
```jsx
import { Accordion, AccordionLayoutTransition } from '@pitsi-ui/native';
