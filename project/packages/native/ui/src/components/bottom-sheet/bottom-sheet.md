...
```tsx
import { BottomSheet } from '@pitsi-ui/native';
```
...
```tsx
import { useBottomSheet, useBottomSheetAnimation } from '@pitsi-ui/native';
...
```tsx
import { BottomSheet, Button } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/bottom-sheet.tsx>).
