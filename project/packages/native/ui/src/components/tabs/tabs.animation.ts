...
import type { TabsIndicatorAnimation, TabsSeparatorAnimation } from "./tabs";
import { useTabsMeasurements } from "./tabs.context";

const DEFAULT_INDICATOR_SPRING_CONFIG: WithSpringConfig = {
  stiffness: 1200,
  damping: 120,
};
 ...
 */
export function useTabsRootAnimation(options: { animation: AnimationRootDisableAll | undefined }) {
...
export function useTabsIndicatorAnimation(options: {
  ...
  }, [activeMeasurements, isAnimationDisabledValue, widthConfig, heightConfig, translateXConfig]);
