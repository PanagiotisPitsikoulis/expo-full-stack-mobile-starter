...
```tsx
import { Tabs } from '@pitsi-ui/native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/tabs.tsx>).
...
```tsx
import { useTabs } from '@pitsi-ui/native';
...
```tsx
import { useTabsMeasurements } from '@pitsi-ui/native';
...
```tsx
import { useTabsTrigger } from '@pitsi-ui/native';
