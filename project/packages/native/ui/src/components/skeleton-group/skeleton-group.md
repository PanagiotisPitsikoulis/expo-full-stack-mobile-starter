...
```tsx
import { SkeletonGroup } from '@pitsi-ui/native';
```
...
```tsx
import { Card, SkeletonGroup, Avatar } from '@pitsi-ui/native';
      ...
      <Card className="p-4">
        ...
        <SkeletonGroup.Item className="h-48 w-full rounded-lg">
          <View className="h-48 bg-surface-tertiary rounded-lg overflow-hidden">
            <Image
              source={{
                uri: 'https://pitsiui-assets.nyc3.cdn.digitaloceanspaces.com/backgrounds/cards/car1.jpg',
              }}
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/skeleton-group.tsx>).
