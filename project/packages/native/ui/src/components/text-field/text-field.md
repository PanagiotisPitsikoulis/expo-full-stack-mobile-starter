...
```tsx
import { TextField } from '@pitsi-ui/native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/text-field.tsx>).
...
```tsx
import { TextField, useTextField } from '@pitsi-ui/native';
