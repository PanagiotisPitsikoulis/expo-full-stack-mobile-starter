...
```tsx
import { TextArea } from '@pitsi-ui/native';
```
...
```tsx
import { Description, Label, TextArea, TextField } from '@pitsi-ui/native';
...
```tsx
import { FieldError, Label, TextArea, TextField } from '@pitsi-ui/native';
...
```tsx
import { Label, TextArea, TextField } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/text-area.tsx>).
