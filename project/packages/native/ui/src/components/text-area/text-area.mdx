...
<NativeVideoPlayerView
  srcLight="https://pitsiui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/text-area-docs-light.mp4"
  srcDark="https://pitsiui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/text-area-docs-dark.mp4"
/>
...
```tsx
import { Description, FieldError, Label, TextArea, TextField } from '@pitsi-ui/native';
