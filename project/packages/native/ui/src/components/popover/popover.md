...
```tsx
import { Popover } from '@pitsi-ui/native';
```
...
import { Button, Popover, useThemeColor } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/popover.tsx>).
...
```tsx
import { usePopover } from '@pitsi-ui/native';
...
```tsx
import { usePopoverAnimation } from '@pitsi-ui/native';
