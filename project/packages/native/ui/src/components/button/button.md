...
```tsx
import { Button } from '@pitsi-ui/native';
```
...
```tsx
import { Button, PressableFeedback } from '@pitsi-ui/native';
...
```tsx
import { Button, useThemeColor } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/button.tsx>).
...
```tsx
import { useButton } from '@pitsi-ui/native';
