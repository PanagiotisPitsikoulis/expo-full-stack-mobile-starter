...
```tsx
import { PressableFeedback } from '@pitsi-ui/native';
```
...
```tsx
import { PressableFeedback, Card, Button } from '@pitsi-ui/native';
  ...
  return (
    <PressableFeedback className="w-full aspect-square overflow-auto">
      <Card className="flex-1">
        <Image
          source={{
            uri: 'https://pitsiui-assets.nyc3.cdn.digitaloceanspaces.com/docs/neo2.jpeg',
          }}
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/pressable-feedback.tsx>).
