...
const [SubMenuAnimationProvider, useSubMenuAnimation] = createContext<SubMenuAnimationContextValue>(
  {
 ...
 */
export function useSubMenuRootAnimation(options: { animation: SubMenuRootAnimation | undefined }) {
...
export { type SubMenuAnimationContextValue, SubMenuAnimationProvider, useSubMenuAnimation };
