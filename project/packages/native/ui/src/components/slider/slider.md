...
```tsx
import { Slider } from '@pitsi-ui/native';
```
...
```tsx
import { Label, Slider } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/slider.tsx>).
...
```tsx
import { useSlider } from '@pitsi-ui/native';
