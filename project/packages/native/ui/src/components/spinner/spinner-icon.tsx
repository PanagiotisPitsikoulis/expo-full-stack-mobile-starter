...
import type { SpinnerIconProps } from "./spinner";
...
// Inlined (not DISPLAY_NAME.ICON) to avoid a require cycle: spinner.tsx imports
// SpinnerIcon before DISPLAY_NAME is initialized, so the const reads as undefined.
SpinnerIcon.displayName = "PitsiUINative.Spinner.Icon";
