...
import type { SpinnerIndicatorAnimation, SpinnerRootAnimation } from "./spinner";
import {
 ...
 */
export function useSpinnerRootAnimation(options: { animation: SpinnerRootAnimation | undefined }) {
