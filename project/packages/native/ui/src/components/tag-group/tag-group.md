...
```tsx
import { TagGroup } from '@pitsi-ui/native';
```
...
```tsx
import { TagGroup, Label, Description, FieldError } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/tag-group.tsx>).
...
```tsx
import { useTagGroup } from '@pitsi-ui/native';
...
```tsx
import { useTagGroupItem } from '@pitsi-ui/native';
