...
```tsx
import { ScrollShadow } from '@pitsi-ui/native';
```
...
```tsx
import { ScrollShadow, Surface } from '@pitsi-ui/native';
import { LinearGradient } from 'expo-linear-gradient';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/scroll-shadow.tsx>).
