...
```tsx
import { Switch } from '@pitsi-ui/native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/switch.tsx>).
...
```tsx
import { useSwitch } from '@pitsi-ui/native';
...
```tsx
import { Description, ControlField, Label } from '@pitsi-ui/native';
