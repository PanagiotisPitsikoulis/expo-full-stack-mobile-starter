...
```tsx
import { Alert } from '@pitsi-ui/native';
```
...
```tsx
import { Alert, Button, CloseButton } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/alert.tsx>).
...
```tsx
import { useAlert } from '@pitsi-ui/native';
