...
```tsx
import { Separator } from '@pitsi-ui/native';
```
...
```tsx
import { Separator, Surface } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/separator.tsx>).
