...
```tsx
import { Select } from '@pitsi-ui/native';
```
...
```tsx
import { Select, Separator } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/select.tsx>).
...
```tsx
import { useSelect } from '@pitsi-ui/native';
...
```tsx
import { useSelectAnimation } from '@pitsi-ui/native';
...
```tsx
import { useSelectItem } from '@pitsi-ui/native';
