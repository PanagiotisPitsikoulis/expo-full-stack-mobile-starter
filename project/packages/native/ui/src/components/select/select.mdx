...
<NativeVideoPlayerView
  srcLight="https://pitsiui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/select-docs-light.mp4"
  srcDark="https://pitsiui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/select-docs-dark.mp4"
/>
