...
```tsx
import { SearchField } from '@pitsi-ui/native';
```
...
```tsx
import { Description, Label, SearchField } from '@pitsi-ui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/search-field.tsx>).
...
```tsx
import { useSearchField } from '@pitsi-ui/native';
