...
```tsx
import { Checkbox } from '@pitsi-ui/native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/pitsiui-inc/@pitsi-ui/native/blob/main/example/src/app/(home)/components/checkbox.tsx>).
...
```tsx
import { useCheckbox } from '@pitsi-ui/native';
