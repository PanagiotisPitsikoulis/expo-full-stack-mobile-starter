...
| Path | Purpose |
|---|---|
| `project/apps/mobile` | Expo React Native app |
| `project/apps/server` | Express API, auth, catalog, reservations, tests |
| `project/packages/core/airbnb` | Shared domain/data logic used by the app |
| `project/packages/headless/airbnb` | Headless providers and client sync logic |
| `project/packages/native/ui` | Local Pitsi UI native component library |
| `project/packages/shared` | Shared endpoint constants |
| `project/db/schema.sql` | MariaDB schema |
